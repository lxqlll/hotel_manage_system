layui.use('table', function(){
    ...
    table.render({
        elem: '#demo'
        ,height: 420
        ,url: baseURL+'/admin/order/historyReservation' //数据接口
        ,title: '用户表'
        ,page: true //开启分页
       //,toolbar: 'default' //开启工具栏，此处显示默认图标，可以自定义模板，详见文档
        ...
        ,cols:  [[ //表头
            ...
            ,{field: 'reserveName', title: '预定人', width:100}
            ,{field: 'idCard', title: '身份证', width:150}
            ,{field: 'phone', title: '电话', width:120}
            ,{field: 'targetDate', title: '入住日期', width: 150}
            ,{field: 'checkOutDate', title: '退房日期', width: 150}
            ,{field: 'guest', title: '客人人数', width: 120}
            ,{field: 'orderDate', title: '订单生成日期', width: 157}
            ,{field: 'roomNumber', title: '预定房间号', width: 135}
            ,{fixed: 'right', width: 0, align:'center', toolbar: '#barDemo'}
        ]]
    });
